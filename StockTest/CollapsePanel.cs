...
namespace My
{
    public partial class CollapsePanel : UserControl
    {
        ...
        private void Tree_ItemDrag1(object sender, ItemDragEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                DoDragDrop(((TreeNode)e.Item).Tag, DragDropEffects.Move);
            }
        }

        private void Tree_ItemDrag(object sender, ItemDragEventArgs e)
        {
            TreeNode lNode = ((TreeView)sender).SelectedNode; 
            DragDropEffects dde1 = DoDragDrop(lNode,DragDropEffects.Move);
        }
        ...
        private void CollapsePanel_DragEnter(object sender, DragEventArgs e)
        {
